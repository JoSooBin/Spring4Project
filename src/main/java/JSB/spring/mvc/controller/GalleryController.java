...
import JSB.spring.mvc.service.GalleryService;
...
public class GalleryController {
    ...
    //그런데 업로드하는 파일은 총 3개이므로
    //MultipartFile file1, MultipartFile file2, MultipartFile file3,형태로 코드작성해야함 -> 다소 불편.
    //따라서 이것들을 배열 형태로 받아오도록 코드를 개선해야 함
